// Version 6
// Improvements over code_5.c:
// - New functions - typedef struct Range, parse_range, evaluate_range
// - Updated handle_command function to handle new commands
// - Updated main function to handle new commands errors and status messages
// - Updated set_cell_value function to handle MIN and MAX functions
// - Added new error statuses to the CommandStatus enum RangeError
