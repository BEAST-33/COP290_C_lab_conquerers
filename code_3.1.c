...
//     // Ensure the cell is within the sheet boundaries
//     if (row < 0 || row >= sheet->rows || col < 0 || col >= sheet->cols) {
//         printf("Invalid cell reference\n");
//         return;
//     }
...
//     // Adjust viewport if near the edges
//     if (sheet->viewport_row > sheet->rows - VIEWPORT_SIZE) {
//         sheet->viewport_row = sheet->rows - VIEWPORT_SIZE;
//     }
//     if (sheet->viewport_col > sheet->cols - VIEWPORT_SIZE) {
//         sheet->viewport_col = sheet->cols - VIEWPORT_SIZE;
//     }
//     if (sheet->viewport_row < 0) sheet->viewport_row = 0;
//     if (sheet->viewport_col < 0) sheet->viewport_col = 0;
// }
